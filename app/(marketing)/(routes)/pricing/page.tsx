    ...
    <div>
      <div className="min-h-screen">
        ...
        <div className="mx-auto max-w-2xl py-20 sm:px-6 sm:pt-14 sm:pb-24 lg:px-8">
          <div className="relative isolate overflow-hidden bg-gradient-to-r from-blue-400 to-indigo-600 px-6 pt-16 pb-14 md:pb-8 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
